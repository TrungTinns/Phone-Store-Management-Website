...
class ProductController extends Controller
{
    ...
    public function store(RequestProduct $request)
    {
        try {
            DB::beginTransaction();
                ...
                DB::commit();
                return redirect()->route('admin.product.show')->with('success','tao san pham thanh cong');
             }
              catch (\Exception $e) 
             {
                DB::rollBack();
    ...
    public function update(RequestProduct $request, $id)
    {
        try {
          ...
          DB::commit();
          return redirect()->route('admin.product.show')->with('success','cap nhat san pham thanh cong');
             }
              catch (\Exception $e) 
             {
                DB::rollBack();
