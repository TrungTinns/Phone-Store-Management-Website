    ...
    {   
         ...
         try {
            ...
            if(!empty($data)){
             ...
             DB::commit();          
             return redirect()->route('admin.index')->with('success','Tao tai khoan thanh cong');
    ...
    public function update(RequestAdminAccountEdit $request , $id)
    {
        try {
            ...
            if(!empty($data)){
             ...
             DB::commit();          
             return redirect()->route('admin.index')->with('success','Update thanh cong');
    ...
    public function roleStore(Request $request)
    {
        if(empty($request->name_role) || empty($request->role_tags)){
           ...
           $role = Role::create([
            ...
            return redirect()->route('admin.role.user')->with('success','them chuc nang thanh cong');
        }
    }
        ...
        if($role){
            if(empty($request->name_role) || empty($request->role_tags)){
               ...
               $role->update([
                ...
                return redirect()->route('admin.role.user')->with('success','cap nhat chuc nang thanh cong');
            }
        }else{
