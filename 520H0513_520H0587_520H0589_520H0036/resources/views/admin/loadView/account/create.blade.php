...
<div class="col-12 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card_title">Tao tai khoan</h4>
                            ...
                            @enderror
                            <!-- email -->
                            <label  class=" pl-2 "  style=" font-size: 14px;">Nhap email</label>
                            ...
                            @enderror
                             <!-- passwords -->
                             <label  class=" pl-2 "  style=" font-size: 14px;">Nhap mat khau</label>
                            ...
                            @enderror
                           <!-- choose category -->
                           <label for="cate" class="pt-3 pl-2 "  style=" font-size: 14px;">Chọn chuc nang</label>
