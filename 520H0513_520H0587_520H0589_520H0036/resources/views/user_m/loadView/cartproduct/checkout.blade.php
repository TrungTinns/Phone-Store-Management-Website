            ...
            <div class="col-12">
                <div class="user-actions accordion">
                    <h3>
                        ...
                        <a class="Returning" href="#" data-toggle="collapse" data-target="#checkout_coupon" aria-expanded="true">click vao de nhap ma code</a>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-=12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required="" name="name" class="form-control" value="{{$customer->sex}}. {{$customer->name}}" readonly>
                                    </div>
                                </div>
                    ...
                    <div class="order_review bg-white">
                        ...
                        <div class="payment_method">
                            <div class="payment_option">
                                ...
                                <div class="custome-radio">
                                    <input class="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios3" value="option2">
                                    <label class="form-check-label" for="exampleRadios3">Chuyen khoan ngan hang</label>
                                </div>
                                <div class="custome-radio">
                                    <input class="form-check-input dvc" type="radio" name="payment_option" id="exampleRadios4" value="option3">
